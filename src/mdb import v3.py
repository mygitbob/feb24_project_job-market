...
# Example usage
folder_path = ['raw_imports/muse', 'raw_imports/okjob', 'raw_imports/reed']
collection_name = ['muse_test', 'okjob_test', 'reed_test']
...
for path, colltn in zip(folder_path, collection_name):
...
################################## Insert in bulk then delete duplicates v2 ##################################
